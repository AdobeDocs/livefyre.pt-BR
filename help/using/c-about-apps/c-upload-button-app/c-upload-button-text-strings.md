...
|  | Incluir título | Permita que os visitantes do site insiram um título com o conteúdo que eles carregam. Por padrão, os visitantes do site podem fazer comentários. Habilitar isso faz um título e um comentário como parte do conteúdo que o visitante do site carrega. |
|  | Exigir mídia | Exigir que os visitantes do site façam upload de uma foto ou vídeo para postar o conteúdo usando o botão Carregar. |
...
|  | Botão de comentário modal | O texto que é exibido na janela onde o visitante do site faz upload do conteúdo após clicar no botão Fazer upload. |
|  | Entrada do título do módulo de comentários | Permitir que o visitante do site insira um título com seu upload. Você pode modificar o conteúdo exibido aqui se tiver selecionado "Incluir título". |
|  | Entrada de mensagem de comentário modal | Permitir que o visitante do site insira uma mensagem com seu upload. |
|  | Texto do Título do Módulo de Confirmação | O título da janela que confirma ao visitante do site que ele carregou o conteúdo com êxito. |
|  | Texto de descrição modal de confirmação | O texto exibido na janela que confirma ao visitante do site que ele carregou o conteúdo com êxito. |
