...
1. A caixa **[!UICONTROL New App]** de diálogo é exibida. Digite um **[!UICONTROL App Title]**, selecione um **[!UICONTROL Site]** e clique **[!UICONTROL Create]** para abrir a página Visão geral do aplicativo.
...
A página de lista Aplicativos fornece acesso a todos os aplicativos existentes do Livefyre.

A página de lista Aplicativos exibe as seguintes informações:
...
* **[!UICONTROL Content Count]**: Lista o número de conteúdos publicados no aplicativo.
...
Você pode usar a guia App Designer para selecionar **[!UICONTROL Style]** e **[!UICONTROL Configuration]** opções para personalizar seus aplicativos.

**[!UICONTROL Style]** As opções são consistentes em todos os tipos de aplicativos; **[!UICONTROL Configuration]** As opções variam de acordo com o aplicativo. A parte inferior do painel **[!UICONTROL Style]** e **[!UICONTROL Configuration]** lista a versão do aplicativo Livefyre para seu aplicativo.

**Selecionar opções de estilo**

Aplicativos de estilo para se ajustar à marca do site. Use as **[!UICONTROL Style]** opções para selecionar a cor e os estilos de fonte do aplicativo.

* **[!UICONTROL Theme]**. Selecione **[!UICONTROL Light]** ou **[!UICONTROL Dark]** para definir a cor do plano de fundo para o conteúdo exibido. As alterações feitas nessa configuração serão refletidas imediatamente na visualização à direita. Essa configuração controla a seleção da cor do plano de fundo, do texto do conteúdo, do identificador do usuário, do carimbo de data e hora, do botão de compartilhamento e do ícone social do aplicativo.

* **[!UICONTROL Brand color]**. Selecione uma cor para seu aplicativo. Essa cor será usada para hashtags, URLs, nomes de usuário, @menções, gráficos de barra e outros componentes específicos do aplicativo, conforme exibido no painel de visualização à direita.
...
Se existir uma versão mais recente do aplicativo, um **[!UICONTROL Update]** botão será exibido.

Clique no botão para atualizar para a versão mais recente. Atualize seu aplicativo para usar todos os aprimoramentos de recursos e correções de erros disponíveis. Depois de atualizadas, visualize as alterações feitas no aplicativo (se houver) e aceite ou rejeite a atualização.

## Adicionar um botão de chamada para ação a um aplicativo {#section_cpf_cmt_bbb}

Adicione um botão Chamada para ação para impulsionar a conversão do UGC.

Para adicionar um botão de Chamada para ação a um aplicativo:

1. Crie um aplicativo Mosaic ou Media Wall.

   Para obter informações sobre as personalizações disponíveis em um mural de mosaico ou de mídia, consulte Personalizações [de](/help/using/c-about-apps/c-mosaic-app/c-mosaic-customizations.md) mosaico ou Personalizações [de mural de](../c-about-apps/c-media-wall-app/r-media-wall-customizations.md#r_media_wall_customizations)mídia.
...
Selecione **[!UICONTROL Exit Preview]** para voltar ao modo de design.

O Modo de visualização oferece as seguintes opções:

* **[!UICONTROL Preview Options]**: Use o menu suspenso para selecionar um formato de visualização (móvel, tablet ou área de trabalho) e se deseja mostrar **[!UICONTROL Sample Data]** ou os dados de fluxo do aplicativo.
...
1. Clique **[!UICONTROL Restore Version]** para clonar a versão selecionada e trabalhar com ela.
...
>[!NOTE]
>
>Não é possível editar um aplicativo enquanto o **[!UICONTROL Version History]** painel estiver aberto.

Se outro editor fizer alterações enquanto a janela do navegador estiver aberta, o Livefyre emitirá uma mensagem de aviso quando você tentar editar o aplicativo, perguntando se deseja retornar à versão de rascunho (antiga). (Isso evita que vários editores simultâneos ignorem acidentalmente as alterações uns dos outros.) Clique em **[!UICONTROL Update to Latest]** para começar a trabalhar na versão mais recente. Clique em **[!UICONTROL Overwrite]** para retornar ao seu estado de trabalho (antigo), aumentar o número da versão do mais recente e continuar trabalhando.
...
1. No **[!UICONTROL Embed Code]** painel que é aberto, copie e cole o trecho de código HTML exibido na sua página da Web.
...
Você pode excluir um aplicativo da lista Aplicativos no Livefyre Studio. Quando você exclui o aplicativo do Studio, o aplicativo fica oculto da exibição, ele não exclui nem interrompe:

* O aplicativo não continua trabalhando em um site.
* Fluxos associados.
