...
* Modere no contexto, visualize threads inteiros e Aprove, Lixeira ou Bozo em partes individuais de conteúdo ou threads completos em um clique.
...
* **[!UICONTROL Items]** lista todo o conteúdo do Livefyre-native e do SocialSync marcado para moderação. Essa guia inclui qualquer pesquisa social ou conteúdo de fluxo que tenha sido sinalizado ou editado após a moderação.
* **[!UICONTROL Streams Premoderation]** lista todo o conteúdo que entra em seus aplicativos a partir do Streams com o Premoderate ativado. (Para obter mais informações, consulte Criação de fluxos.)
...
Cada conteúdo listado exibe informações de visualização, incluindo o site onde foi publicado e seu autor. Selecionar um item exibirá todo o conteúdo, incluindo qualquer mídia.
...
* **[!UICONTROL Flag Type:]** Ofensivo, Discordo, Spam e etc.
   ...
   * Sinalizadores aplicados pela SAFE: Discurso de ódio, PII (Informações pessoais identificáveis), insulto e proficiência.
...
* **[!UICONTROL More info:]** lista detalhes do conteúdo, incluindo o número de Curtir, Sinalizadores de usuário, Respostas e quaisquer tags aplicadas ao conteúdo. Clicar no Site abre a página de nível superior do site no qual o conteúdo está localizado. Clicar no carimbo de data e hora abre uma exibição segmentada do conteúdo no contexto da página.

## Opções de filtro no ModQ {#section_r2c_qc2_yy}

Clique **[!UICONTROL Filter]** na parte superior esquerda da janela ModQ para abrir um painel com opções de filtro disponíveis para o conteúdo listado. À medida que você seleciona opções, o ModQ será atualizado automaticamente para listar somente o conteúdo filtrado. Clique **[!UICONTROL Clear filters]** para limpar todas as opções selecionadas e recarregue a lista completa de itens.
...
* **[!UICONTROL System Flags]**. Filtre o conteúdo por regras como Spam, Profanity, SAFE e Premoderation.
   ...
   * Selecionar **[!UICONTROL Profanity]** listará todo o conteúdo marcado como Profane pela sua Rede ou Lista de perfis do site.
   * A seleção **[!UICONTROL SAFE]** listará todo o conteúdo inserido no ModQ como resultado das Regras SAFE.
   * A seleção **[!UICONTROL Premoderation]** listará todo o conteúdo marcado para Premoderação pela rede, fluxo ou configurações do aplicativo.
...
* ****[!UICONTROL Confirm Trash]**** Ative essa opção para exigir que os Moderadores confirmem sua ação ao configurar o conteúdo como Lixeira. Quando ativada, selecionar **[!UICONTROL Trash]** para conteúdo exibirá uma caixa de diálogo solicitando uma **[!UICONTROL Reason for Moderation]** e oferecerá um campo no qual uma **[!UICONTROL Note]** opção pode ser inserida.
...
Clique no **[!UICONTROL User actions]** botão do painel Resumo do usuário para Silenciar, Banir ou Listar o usuário em branco.
...
* **[!UICONTROL Whitelist:]** permite que você inclua na lista de permissões o usuário listado para seu site ou rede. (Somente administradores do Studio ou gerentes de usuários podem adicionar uma lista de permissões de rede a um usuário.)
