---
description: Você pode estilizar seus aplicativos Livefyre para se comportar de várias formas ou alterá-los para que fiquem parecidos com o resto da sua campanha de marca.
seo-description: Você pode estilizar seus aplicativos Livefyre para se comportar de várias formas ou alterá-los para que fiquem parecidos com o resto da sua campanha de marca.
...
Você pode estilizar seus aplicativos Livefyre para se comportar de várias formas ou alterá-los para que fiquem parecidos com o resto da sua campanha de marca.

## Estilo padrão {#section_yjl_rfs_d1b}

Você pode criar o estilo de um aplicativo no Studio no App Designer sem precisar usar o Livefyre.js para personalizar o aplicativo.
