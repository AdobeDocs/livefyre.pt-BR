...
É possível especificar configurações de tradução para todos os aplicativos, exceto Storify 2. Para obter mais informações sobre quais campos você pode localizar, consulte [Localizar sequências de caracteres](/help/using/c-settings-other/c-translation-sets/c-localize-strings.md).
...
|  | ratingValues | Uma matriz. Padrão = [&quot;Pobre&quot;, &quot;Pobre&quot;, &quot;Justo&quot;, &quot;Justo&quot;, &quot;Média&quot;, &quot;Boa&quot;, &quot;Boa&quot;, &quot;Excelente&quot;, &quot;Excelente&quot;]; |
...
| *Contagem do notificador do comentário* |  |  |
...
|  | voteUpvote | Sim |
| *Sinalizar modal* |  |  |
|  | flagTitle | Sinalizar revisão de %s |
...
| Elemento | Chave | Texto padrão |
|---|---|---|
| *Cadeias de caracteres do menu de autenticação* |  |  |
...
|  | questionExplication | Agora é possível ler e escrever comentários diretamente em frases, parágrafos, imagens e aspas. <br>Realce o texto e clique no ícone ou clique no ícone no final de cada parágrafo. |
